...
//
//    var githubData = GithubData.FromJson(jsonString);

namespace GithubConverter
{
    using System;
    ...
    public partial class GithubData
    {
        public static GithubData[] FromJson(string json) => JsonConvert.DeserializeObject<GithubData[]>(json, GithubConverter.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this GithubData[] self) => JsonConvert.SerializeObject(self, GithubConverter.Converter.Settings);
    }
